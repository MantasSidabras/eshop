      ...
      <Wrapper onClick={onCancel}>
        <ScaleUp>
          <Message onClick={e => e.stopPropagation()}>
            Another user already updated this product!
            <Buttons>
              <Delete onClick={this.props.handleOverwrite}>Save and overwrite</Delete>
              <Cancel onClick={this.props.handleRefresh}>Get lastest change</Cancel>
            </Buttons>
          </Message>
        </ScaleUp>
      </Wrapper>
